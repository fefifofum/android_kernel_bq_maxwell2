...
static struct reginfo sensor_init_data[] =
{
	...
	{0x1c, 0x04},
	{0x1e, 0x08},
	{0x1f, 0xc8}, //Analog_mode2//[7:6] comv_r  0xc0
	{0x20, 0x00},
	{0x21, 0x48},
	{0x22, 0xba},
	{0x23, 0x22},
...
//smallest gamma curve
	...
	{0x11, 0x21},//a1
	{0x12, 0x07}, 
	{0x13, 0x58}, //Y target   // 0x48  hhs_0413
	{0x17, 0x88}, 
	{0x21, 0xb0},
	{0x22, 0x48},
	{0x33, 0x30}, // honghaishen hhs_0130
	{0x3c, 0x95},
	{0x3d, 0x50},
	{0x3e, 0x48},
			       ...
			       struct i2c_client *client)
{
   ...
   /* ret = sensor_write(client, 0x12, 0x80);
    ...
    if (ret != 0) {
		...
		printk("honghaishen_test gc0329 no \n");
        ret = -ENODEV;
        goto sensor_video_probe_err;
    }
    ...
    if (pid == SENSOR_ID) {
		...
		printk("honghaishen_test gc0329 ok \n");
    } else {
