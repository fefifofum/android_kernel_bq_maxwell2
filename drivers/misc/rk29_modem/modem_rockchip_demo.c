...
/*3G_WAKE_OUT PIN*/
#define RK30_AP_WAKEUP_BP        RK30_PIN6_PA1
#define RK30_AP_WAKEUP_BP_IOMUX

/*3G_EN PIN*/
#if defined(CONFIG_BQ_D8002)
#define RK30_3G_DISABLE          RK30_PIN2_PB6
#define RK30_3G_DISABLE_IOMUX    rk29_mux_api_set(GPIO2B6_LCDC1DATA14_SMCADDR18_TSSYNC_NAME, GPIO2B_GPIO2B6)
#else
#define RK30_3G_DISABLE          RK30_PIN1_PB2
#define RK30_3G_DISABLE_IOMUX    rk29_mux_api_set(GPIO1B2_SPDIFTX_NAME, GPIO1B_GPIO1B2)
#endif

/*3G_W_DISABLE PIN*/
#if defined(CONFIG_BQ_D8002)
#define RK30_3G_SUSPEND          RK30_PIN2_PC0
#define RK30_3G_SUSPEND_IOMUX	rk29_mux_api_set(GPIO2C0_LCDCDATA16_GPSCLK_HSADCCLKOUT_NAME, GPIO2C_GPIO2C0)
#else
