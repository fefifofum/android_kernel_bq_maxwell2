...
E_UPGRADE_ERR_TYPE  fts_ctpm_fw_upgrade(FTS_BYTE* pbt_buf, FTS_DWRD dw_lenth)
{
 ...
 UPGR_START:
    ...
    #else
    #if defined(CONFIG_BQ_D7008)||defined(CONFIG_BQ_D8005)||defined(CONFIG_BQ_C7022)||defined(CONFIG_BQ_D9001)
...
//		printk("==ft5x0x_report_value =\n");
	...
	if (event->touch_point == 1) {
#if (defined(CONFIG_BQ_C7022) ||defined(CONFIG_BQ_C7018) )
...
ft5x0x_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
        ...
        if( uc_reg_value != 0xff )
	{
		...
		if( uc_reg_value == 0xa6)
          ...
          #if (defined(CONFIG_BQ_D8005))
          	if(( uc_reg_value < 0x17) && ( uc_reg_value > 0x10))
...
#if (defined(CONFIG_BQ_C7022) ||defined(CONFIG_BQ_C7018)|| defined(CONFIG_BQ_D7008))
