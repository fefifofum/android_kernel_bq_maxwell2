...
#define RK29_CAM_SENSOR_GT2005_FRONT  gt2005_front
#define RK29_CAM_SENSOR_HI253_FRONT hi253_front  
#define RK29_CAM_SENSOR_GC2035  gc2035
#define RK29_CAM_SENSOR_GC2035_FRONT  gc2035_front
#define RK29_CAM_SENSOR_OV5640_1006A ov5640_1006a
...
#define RK29_CAM_SENSOR_SID130B_BACK  sid130B_back
...
enum rk29camera_vdd_val
{
	VDD_18V,     // 1.8 V 
       VDD_15V      // 1.5V FOR SID130B
};
...
struct rk29camera_platform_ioctl_cb {
    int (*sensor_power_cb)(struct rk29camera_gpio_res *res, int on,enum rk29camera_vdd_val vol_value);
