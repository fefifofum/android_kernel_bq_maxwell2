...
static struct resource rk30_hsadc_resource[] = {
	...
	{
		.start = RK30_HSADC_PHYS,
		.end   = RK30_HSADC_PHYS + RK30_HSADC_SIZE - 1,
		.flags = IORESOURCE_MEM,
	},
	{
		.start  = DMACH_HSADC,
...
struct platform_device rk30_device_hsadc = {
	.name		  = "rk30-hsadc",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(rk30_hsadc_resource),
